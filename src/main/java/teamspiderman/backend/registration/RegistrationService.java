package teamspiderman.backend.registration;

import teamspiderman.backend.appuser.AppUser;
import teamspiderman.backend.appuser.AppUserRole;
import teamspiderman.backend.appuser.AppUserService;
import teamspiderman.backend.email.EmailSender;
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appUserService.signUpUser(
                new AppUser(
                        ...
                        request.getEmail(),
                        request.getPassword(),
                        request.getUserProfileImageLink(),
                        AppUserRole.USER
