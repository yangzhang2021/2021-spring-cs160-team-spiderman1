                ...
                <div className='server-tab-sub'>
                    <div className ='server-tab-sub-sub'>
                        ...
                        <div className='nav-bar'>
                            <a href="./login.html" id="articles" className='nav-title'>Intangable</a>
                            <span className='vertical-bar'>|</span>
                            <a href="./iBlog.html" id="articles" className='title-s'>iBlog</a>
                            
                            <span className='vertical-bar'>|</span>
                            <a href="./login.html" id="articles" className='title-s'>Article</a>
                            
                            <span className='vertical-bar'>|</span>
                            <a href="./login.html" id="articles" className='title-s'>Recent Work</a>
                            
                            <span className='vertical-bar'>|</span>
                            <a href="./login.html" id="articles" className='title-s'>Selling</a>
